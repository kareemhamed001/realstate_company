...
@section('content')
    ...
    @section('breadcrumb')
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Cover & Services</li>
            </ol>
        </nav>
    @endsection
    ...
    <div class="">
        <div class="d-flex px-2">
            <h3 class="heading p-0">Cover Photos</h3>
    ...
    <div class="row d-flex flex-wrap m-0">
        ...
        <div class="row  justify-content-center" id="coversContainer">

        </div>
        <div class=" overflow-auto d-flex justify-content-center w-100" id="coversPagination">
    ...
    <div class="d-flex flex-wrap m-0">
        ...
        <div class=" overflow-auto d-flex justify-content-center w-100" id="servicesPagination">
    ...
    @section('js')
        @vite(['resources/js/Dashboard/Services/Service/main.js','resources/js/Dashboard/Services/Cover/main.js'])
