...
class Project {
    ...
    async list(page, perPage = 10) {
        let request = new RequestBuilder()
            .setUrl(routes.client.project.list.url + "?page=" + page + "&pagination=" + perPage)
    ...
    async show(id) {
        let request = new RequestBuilder()
            .setUrl(routes.client.project.show.url.replace("{service}", id))
    ...
    async register(id, data) {
        let request = new RequestBuilder()
            .setUrl(routes.client.project.register.url.replace('{project}', id))
            .setMethod(routes.client.project.register.method)
            .setHeaders({'Accept': 'application/json', ...this._headers})
            .setResponseType(this._responseType)
            .setPreviewType(this._previewType)
            .setData(data)
