...
const logoDescriptionContainer = document.querySelectorAll('.logo-description');
    ...
    try {
       ...
       if (scrollUpButton){
        ...
        if (settingResponse.response) {
            ...
            if (settingResponse.response.data && settingResponse.response.data.data && settingResponse.response.data.data.data) {
                let data = settingResponse.response.data.data.data;
                if (data.length > 0) {
                    ...
                    let logoDescription = data.website_description;
                    ...
                    if (logoDescriptionContainer) {
                        logoDescriptionContainer.forEach(item => {
                            item.innerHTML = logoDescription;
                        })
                    }

                    if (metaDescription) {
                        metaDescription.setAttribute('content', aboutUs);
                    }
